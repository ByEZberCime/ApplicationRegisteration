...
import com.applicationregisteration.fx.byezbercime.BackgroundApplicationStorage;
            ...
            try {
                ...
                if (!syncCooldownManager.getBackgroundSyncCooldowns().isEmpty()) {
                    for (Map.Entry<String, Long> entry : syncCooldownManager.getBackgroundSyncCooldowns().entrySet()) {
                        ...
                        if (entry.getKey().equals("register_error_is_empty")) {
                        ...
                        } else if (entry.getKey().equals("register_error_is_password_wrong")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_is_email")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_is_birthday")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_of_name")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_of_username")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_of_username_uppercase")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_is_phonenumber_invalid")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_is_country_not_support")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_error_is_password_character_not_enough_wrong")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_success_registered_content")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                        ...
                        } else if (entry.getKey().equals("register_and_next_intant")) {
                            if (registerActivity.getAuthenticationManager().isOverloadCooldownData(nowDate,beforeDate)) {
                                ...
                                new Handler(Looper.getMainLooper()).post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent mainIntant = new Intent(registerActivity.getApplicationContext(), MainPageActivity.class);

                                        getInstance().startActivity(mainIntant);
                                        getInstance().finish();
